...
ModelOutput = namedtuple(
    "ModelOutput", ["vertices", "joints", "joints_from_verts", "rot_mats", "offset"]
)
...
class SMPL_layer(nn.Module):
    ...
    def forward(
        self, pose_axis_angle, betas, global_orient, transl=None, return_verts=True
    ):
        ...
        if transl is not None:
            ...
            joints_from_verts_h36m = joints_from_verts_h36m - offset
